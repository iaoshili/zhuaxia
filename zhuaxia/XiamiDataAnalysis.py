...
def Main():
	shall_I_begin("http://www.xiami.com/song/1773783592?spm=a1z1s.6843761.6353689.4.Hco8EC", \
		is_file=False, is_hq=True, need_proxy_pool = True)
Main()
